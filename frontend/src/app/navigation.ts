  ...
  },
  {
    ...
    items: [
      ...
      { to: "/invest/modele", label: "Modèle de décision", icon: DecisionModelIcon,
        aliases: ["jev", "ia", "modèle", "vllm", "ollama", "system one", "laya"] },
      { to: "/invest/journee", label: "La journée", icon: CalendarIcon,
        aliases: ["séance", "simulation", "journée simulée", "backtest", "bac à sable",
                  "profit", "courbe de capital"] },
    ],
  },
  {
